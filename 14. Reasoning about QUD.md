...
- Literal Listener: $L_{0, Q} (a | u) = \Sigma_{s: Q(s) = a}\ L_0 (s |u)$ 
- Pragmatic Speaker: $S_1 (u | s, Q) = \displaystyle \frac{e^{\alpha \cdot U'(u,s,Q)}}{\Sigma_{u \in U}\ e^{\alpha \cdot U'(u,s,Q)}}$
- 

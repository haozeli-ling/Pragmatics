...
$P_{S_1} (u | Q, t, e) = \displaystyle \frac{e^{{\ }\alpha \cdot \text{Utility}'(u,Q,t,e)}}{\Sigma_{u' \in U}\ e^{{\ }\alpha \cdot \text{Utility}'(u',Q, t, e)}}$  here $\text{Utility}'(u,s) = \ln (L_{0, Q} (a\ |\ u)) - \text{Cost}'(u)$

...
For Q_e, $\Sigma_{s' \in S}\ P_{S_1} (u | Q_e, s') \cdot P(s') \cdot P(Q_e) = $

- $P_{L_1} (\text{fine}, Q_e | \text{'1mY'}) = \displaystyle \frac{0.0000683 \cdot 0.01 \cdot 0.5}{0.0000683 \cdot 0.01 \cdot 0.5 +   } $

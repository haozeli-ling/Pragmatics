...
- $L_0 (45mins, frustrated\ |\ '45mins') = \displaystyle \frac{1 \cdot 0.88}{0.11 + 0.88 + 0 + 0} \approx 0.89 $
...
- $P_{L_1} (\text{1mY, frustrated}, Q_e | \text{'1mY'}) \approx \displaystyle \frac{0.6051 \cdot 0.099 \cdot 0.5}{0.296103774} \approx 0.1014$

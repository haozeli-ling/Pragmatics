...
- Using $\ln$ reflects this intuition, as differences in smaller probabilities are stretched, giving them greater weight.
  ...
  - For $P(u) = 0.9$, $\ln(0.9) \approx 0.105$; for $P(u) = 0.8$, then $\ln(0.9) \approx 0.223$; the difference between $P(u) = 0.9$ and $P(u) = 0.8$ is $(0.223 - 0.105) = 0.118$
  - For $P(u) = 0.2$, $\ln(0.2) \approx 1.609$; for $P(u) = 0.1$, then $\ln(0.1) \approx 2.302$; the difference between $P(u) = 0.9$ and $P(u) = 0.8$ is $(2.302 - 1.609) = 0.693$

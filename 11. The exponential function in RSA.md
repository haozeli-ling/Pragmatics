...
If the decision is made based on the hard maximization of utilities, the speaker would choose one utterance whose utility is strictly highest among all alternatives. As a consequence, they would not have any chance to use 'good'. 

# 11. The exponential function in RSA
...
If the decision is made based on the hard maximization of utilities, the speaker would choose one utterance whose utility is strictly highest among all alternatives. As a consequence, they would never use 'good'. However, this does not align with the fact of language use. 

...
In a downward-entailing context, a scalar item may not trigger the scalar implicature when this item in the down-entailment context entails all of its alternatives. 

...
Consider " $\color{blue}{\text{or}}$ " again. A disjunctive sentence does not raise a conjunctive implicature. 

4. The emperor lives in the Forbidden City $\color{blue}{\text{or}}$ the Summer Palace. <br>
   $\leadsto$ The emperor lives in the Forbidden City or the Summer Palace, but $\color{blue}{\text{not both}}$ . <br>
   $\not\leadsto$ The emperor lives in the Forbidden City $\color{blue}{\text{and}}$ the Summer Palace.
...
[Next session](https://github.com/haozeli-ling/Pragmatics/blob/main/08.%20Rational%20Speech%20Act.md)

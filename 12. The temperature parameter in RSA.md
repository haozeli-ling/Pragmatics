# 12. The temperature parameter in RSA 
...
If $\alpha = 10$, the exponential functions are: $\text{exp}(10 \times -0.1) \approx 0.368$ and $\text{exp}(10 \times -0.2) \approx 0.135$

- $P(u_1 \mid s) = \displaystyle \frac{0.368}{0.135 + 0.368} \approx 0.732$
- $P(u_2 \mid s) = \displaystyle \frac{0.135}{0.135 + 0.368} \approx 0.268$

If $\alpha = 20$, the exponential functions are: $\text{exp}(20 \times -0.1) \approx 0.135$ and $\text{exp}(20 \times -0.2) \approx 0.018$

- $P(u_1 \mid s) = \displaystyle \frac{0.135}{0.135 + 0.018} \approx 0.882$
- $P(u_2 \mid s) = \displaystyle \frac{0.018}{0.135 + 0.018} \approx 0.118$

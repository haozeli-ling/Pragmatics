...
In the early 1960s, [Chomsky](https://en.wikipedia.org/wiki/Noam_Chomsky) demonstrated how natural language syntax can be understood based on rules and constraints. However, Chomsky did not believe that meaning could be studied in the same way. 

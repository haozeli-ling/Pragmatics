...
>
> $\text{Utility}'(u,s) = \ln (P_{L_0}(s|u)) - \text{Cost}'(u)$ Let's jump to [the 9th session](https://github.com/haozeli-ling/Pragmatics/blob/main/09.%20Informativeness%20in%20RSA.md)

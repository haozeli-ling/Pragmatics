...
Reasoning about the literal listener informs the pragmatic speaker rule: $P_{S_1} (u | s) = \displaystyle \frac{e^{\alpha \cdot \ts{Utility}'(u,s)}}{\Sigma_{u' \in U} e^{\alpha \cdot \ts{Utility}'(u',s)}}$

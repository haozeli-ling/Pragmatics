...
1. John or Bill showed up.
   ...
   - In First Order Logic (FOL), the sentence is true if and only if John showed up, Bill showed up, or both showed up. 
...
2. Peter did some of the homework.
   ...
   - In FOL, the sentence is true if and only if Peter did at least some of the homework. 
   - So, it can be true if Peter did all of the homework. 
...
3. Sue bought three houses.
   ...
   - In FOL, the sentence is true if and only if Sue bought at least three houses. 
   - So, it can be true if Sue bought more than three houses. 
...
All examples involve a lexical item that triggers $\color{red}{\text{scalar alternatives}}$

> [!IMPORTANT]
> coordinations: (or, and) <br>
> quantifiers: (some, many, most, every/all) <br>
> numerals: (one, two, three, . . .) <br>
> modals: (allowed to, required to) <br>
...
- Assuming that the speaker is cooperative, he is following $\color{red}{\text{the Maxim of Quantity}}$ and $\color{red}{\text{the Maxim of Quality}}$ .
- Therefore, her statement was **true and most informative**.
- The scalar alternatives to the utterance include:
   - Peter did $\color{blue}{\text{all}}$ of the homework. 
   - Peter did $\color{blue}{\text{most}}$ of the homework.
   - Peter did $\color{blue}{\text{many}}$ of the homework.
...
- Since the speaker didn’t utter 'Peter did all of the homework', it follows that such an utterance would have broken the Maxim of Quality.
...
> [!NOTE]
> The reasoning relies upon the following assumption: The speaker knows the truth value of 'Peter did all of the homework'. Therefore, if the assumption does not hold in context, then the scalar implicature in question won't arise. 
> 
...
[Next session](https://github.com/haozeli-ling/Pragmatics/blob/main/06.%20Implicatures%20and%20Semantics.md)
